  ...
  const getData = async () => {
    ...
    try {
      ...
      if (teacherView) {
        ...
        actionButtons.push({
          icon: disabledStudent ? <Check /> : <NotInterested />,
          name: disabledStudent ? "Reativar" : "Desativar",
    ...
    <Fragment>
      {!disabledStudent &&
        <ReleasePerformance
          ...
          onClose={setOpenReleasePerformanceGrades}
      ...
      <ViewStudentHistory
        isDisabled={false}
        studentId={studentId}
        isOpen={openStudentHistory}
        onClose={setOpenStudentHistory}
      />
