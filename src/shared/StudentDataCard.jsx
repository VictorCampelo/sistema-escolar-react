          ...
          <CardContent>
            ...
            <List component="nav" aria-label="informações adicionais do aluno">
              ...
              <ListItem>
                <ListItemText>
                  {" "}
                  Endereço: {studentData.enderecoAluno}, {studentData.numeroAluno},{" "}
                  {studentData.bairroAluno}, {studentData.cidadeAluno}, {studentData.estadoAluno},
                  CEP: {studentData.cepAluno}{" "}
                </ListItemText>
              </ListItem>
            </List>
          </CardContent>
