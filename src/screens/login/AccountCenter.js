...
import { AccountCircle, CameraAlt, Close, Save, VerifiedUser } from "@material-ui/icons";
...
const AccountCenter = ({ onClose }) => {
  ...
  const handleUpdateName = async (name) => {
    try {
      ...
      setIsLoading(false);
      enqueueSnackbar("Nome atualizado com sucesso. Atualize a página.", {
        title: "Sucesso",
        variant: "success",
        key: "0",
        action: (
  ...
  const handleEmailVerification = async () => {
    try {
      ...
      enqueueSnackbar("E-mail de verificação enviado. Verifique sua caixa de entrada ou SPAM.", {
        title: "Info",
        variant: "info",
        key: "0",
        action: (
  ...
  const handlePasswordRecover = async () => {
    try {
      ...
      enqueueSnackbar(
        "E-mail para alteração de senha enviado. Verifique sua caixa de entrada ou SPAM.",
        {
          title: "Info",
          variant: "info",
          key: "0",
              ...
              <Typography component="h1" variant="h5" onClick={() => setShowUpdateName(true)}>
                {showUpdateName ? (
                  <>
                    ...
                    />
                    <IconButton style={{ float: "right" }} onClick={() => setShowUpdateName(false)}>
                      <Save fontSize="small" />
                    </IconButton>
                  </>
                ) : (
