    ...
    <Fragment>
      <form id="infoEscolaForm" onSubmit={handleSubmit}>
          ...
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                id={"cnpjEscola"}
                name={"cnpjEscola"}
                aria-describedby={"CNPJ da Escola"}
                onKeyPress={(e) => $(e.target).mask("99.999.999/9999-99")}
              />
            </FormControl>
          </Grid>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                id={"nomeEscola"}
                name={"nomeEscola"}
                aria-describedby={"Nome da Escola"}
              />
            </FormControl>
          </Grid>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                id={"enderecoEscola"}
                name={"enderecoEscola"}
                aria-describedby={"Endereço da Escola"}
              />
            </FormControl>
          </Grid>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                id={"telefoneEscola"}
                name={"telefoneEscola"}
                aria-describedby={"Telefone da Escola"}
                onKeyPress={(e) => $(e.target).mask("(99) 999999999")}
              />
            </FormControl>
          </Grid>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                id={"emailEscola"}
                name={"emailEscola"}
                aria-describedby={"E-mail da Escola"}
              />
            </FormControl>
          </Grid>
        </Grid>
        ...
        <Grid justifyContent="flex-start" container direction="row" spacing={1}>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              ...
              <Input
                type="color"
                label="Cor primária da escola"
                name="corPrimariaEscola"
                id="corPrimariaEscola"
                style={{ width: "219px" }}
              />
            </FormControl>
          </Grid>
          <Grid item>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              ...
              <Input
                type="color"
                label="Cor secundária da Escola:"
                name="corSecundariaEscola"
                id="corSecundariaEscola"
                style={{ width: "219px" }}
              />
            </FormControl>
          </Grid>
          ...
          <Grid item xl={6}>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                type="text"
                id={"pontosAprovacao"}
                name={"pontosAprovacao"}
                aria-describedby={"Nota mínima para aprovação"}
              />
          ...
          <Grid item xl={6}>
            <FormControl className={S.fields} style={{ width: "100%" }}>
              <TextField
                ...
                variant="filled"
                label={"Frequência mínima de aprovação"}
                type="text"
                id={"frequenciaAprovacao"}
                name={"frequenciaAprovacao"}
                aria-describedby={"Frequência mínima para aprovação"}
              />
              <FormHelperText>
                Porcentagem mínima de frequência para que o aluno seja aprovado
              </FormHelperText>
            </FormControl>
          </Grid>
        </Grid>
        <FormControl component="fieldset">
          ...
          <FormGroup>
            <FormControlLabel
              control={
                <Switch
                  checked={checked}
                  value={"permitirDistribuiNotas"}
                  onChange={(e) => setChecked(e.target.checked)}
                  name="permitirDistribuiNotas"
                  id="permitirDistribuiNotas"
                />
              }
          ...
          <FormHelperText>
            Caso você não permita, a secretaria será a responsável por definir as pontuações máximas
            de atividades da turma, ou seja, será responsável por distribuir as notas.
          </FormHelperText>
        </FormControl>
        ...
        <Grid justifyContent="flex-start" container direction="row" spacing={1}>
          ...
          <Grid item xl={6}>
            <FormControl style={{ width: "100%" }}>
              <TextField
                placeholder={"Insira o nome ou razão social do beneficiário..."}
                autoComplete="off"
                InputLabelProps={{ shrink: shrink }}
                variant="filled"
              ...
              />
              <FormHelperText>
                Nome completo ou razão social do beneficiário na conta bancária atrelada
              </FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xl={6}>
          ...
          <Grid item xl={6}>
            <FormControl variant="filled">
              <InputLabel htmlFor="filled-age-native-simple">
                Quando o dia do vencimento da parcela não existir...:
              </InputLabel>
              <Select
                InputLabelProps={{ shrink: false }}
                native
              ...
              >
                ...
                <option value={"false"}>
                  ...adiantar o vencimento para último dia do mesmo mês.
                </option>
              </Select>
              <FormHelperText>
                Usado na geração de boletos para decidir nos dias que não existirem em certos meses
              </FormHelperText>
            </FormControl>
          </Grid>
        </Grid>
