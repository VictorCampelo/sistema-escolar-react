...
import {
  AssignmentTurnedIn, FormatListNumberedRtl,
  Help, Refresh
          ...
          for (const i in gradesArray) {
            ...
            if (Object.hasOwnProperty.call(gradesArray, i)) {
              tempGrade.push({
                ...
                value:
                  key === "Desempenho"
                    ? studentResults && studentResults.hasOwnProperty("Desempenho")
                      ? studentResults.Desempenho
                      : 0
                    : 0,
                readonly: key === "Desempenho"
              });
            }
          }
        ...
        <DialogContent>
          <div>
            <div>
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    defaultChecked={
                      grades.length !== 0 && grades.filter((grade) => grade.readonly === true)[0]
                    }
                  />
                }
              ...
              <Tooltip
                title={
                  "Ao marcar esta caixa, o somatório das notas de desempenho (que são definidas pela secretaria) será adicionado automaticamente ao somatório da distribuição de notas desta turma."
                }
              >
                <Help fontSize="small" />
              </Tooltip>
          ...
          <div className={S.flex}>
            ...
            <div>
              ...
              <label>
                Somatório: <label style={{ color: sum > 100 ? "#FF0000" : "" }}>{sum}</label>/100
              </label>
            </div>
          </div>
        </DialogContent>
