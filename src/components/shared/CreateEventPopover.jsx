...
const CreateEventPopover = ({
  ...
  const handleEventSave = async (e) => {
    ...
    try {
      ...
      enqueueSnackbar("Evento adicionado!", {
        title: "Sucesso",
        variant: "success",
        key: "0",
        action: (
    ...
    <Fragment>
      ...
      >
        ...
        {eventsSources.length === 0 && !isFromClassCode && (
          <DialogContent>
            <IconButton onClick={handleOpenNewCalendarDialog}>
              <Add />
            </IconButton>
            Novo calendário
            <br />
            ...
            <Typography variant="p">
              Para começar a marcar os eventos, crie um calendário.
            </Typography>
          </DialogContent>
        )}
            ...
            <DialogContent>
              ...
              <Box m={1}>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setSourceSelected(
                      eventsSources.filter((source) => source.id === e.target.value)[0]
                    )
                  }
                  label="Calendário"
                  required
                >
                  ...
                  {eventsSources.length > 0 &&
                    eventsSources.map((source, i) => (
                      <MenuItem key={source.id} id={source.id} value={source.id}>
                        {source.id}
                      </MenuItem>
                    ))}
                </Select>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) => setRecurrenceEnd(e.target.checked)}
                          name="antoine"
                        />
                      }
                      label="Nunca termina"
