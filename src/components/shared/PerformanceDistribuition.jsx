...
import { performanceGradesRef } from "../../services/databaseRefs";
    ...
    <Fragment>
      <Dialog open={open} onClose={handleClose} fullScreen={fullScreen}>
        ...
        <DialogContent>
          <div>
            <div>
              <Button endIcon={<Refresh />} onClick={getData}>
                Atualizar
              </Button>
            </div>
          </div>
          ...
          <div className={S.flex}>
            ...
            <div>
              ...
              <label>
                Somatório: <label style={{ color: sum > 100 ? "#FF0000" : "" }}>{sum}</label>
              </label>
            </div>
          </div>
        </DialogContent>
