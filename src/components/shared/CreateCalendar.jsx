...
const CreateCalendar = (props) => {
  ...
  const handleCreateCalendar = async (e) => {
    ...
    enqueueSnackbar("Calendário criado com sucesso!", {
      title: "success",
      variant: "success",
      key: "0",
      action: (
  ...
  return (
    <Fragment>
      ...
      >
        <Container>
          <Typography variant="h6">Dados do novo calendário</Typography>
          <Typography variant="p" component={"p"}>
            Crie quantos calendários precisar. Os calendários servem para organizar os eventos da
            agenda da sua escola de uma maneira melhor.
          </Typography>
          <Typography variant="p" component={"p"}>
            Importante saber: sempre que uma sala é aberta no sistema, é criado para ela um
            calendário separado contendo os dias de aula, após a turma ser fechada, o calendário é
