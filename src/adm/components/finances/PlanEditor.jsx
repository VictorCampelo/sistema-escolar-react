...
const PlanEditor = ({ courseId, planId = undefined, isOpen, setOpenDialog }) => {
  ...
  const contractHandler = async (elemId = "", planChosen = null, save) => {
    ...
    if (
      internData.hasOwnProperty("diasDeVencimento") &&
      !Array.isArray(internData.diasDeVencimento)
    ) {
    ...
    try {
      ...
      for (let parcela = 0; parcela < Number(internData.numeroMaximoParcelasPlano); parcela++) {
        let row = {};
        if (
          internData.hasOwnProperty("distribuirAcrescimosEDescontos") &&
          internData.distribuirAcrescimosEDescontos === "on"
        ) {
          ...
          row = {
            ...
            col1: `Parcela ${parcela + 1}`,
            col2: `R$${parseFloat(
              internData.valorFinal / internData.numeroMaximoParcelasPlano
            ).toFixed(2)}`,
            col3: "0",
            col4: "0",
            col5: `R$${parseFloat(
          ...
          somaParcelas += Number(
            parseFloat(internData.valorFinal / internData.numeroMaximoParcelasPlano)
          );
        }
        saldo =
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="nomePlano"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.nomePlano}
                      />
                      <FormHelperText>
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="valorCurso"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.valorCurso}
                      />
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="descontoPlano"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.descontoPlano}
                      />
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        id="valorDesconto"
                        name="valorDesconto"
                        defaultValue={calculatedData.valorDesconto}
                        aria-describedby="my-helper-text"
                      />
                    </FormControl>
                  </Grid>
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="acrescimoPlano"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.acrescimoPlano}
                      />
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="valorAcrescimo"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.valorAcrescimo}
                      />
                    </FormControl>
                  </Grid>
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        name="valorFinal"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.valorFinal}
                      />
                    </FormControl>
                  </Grid>
                </Grid>
                ...
                <Grid justifyContent="flex-start" container direction="row" spacing={2}>
                  <Grid item>
                    <FormControl className={classes.fields}>
                      <TextField
                        ...
                        InputLabelProps={{ shrink: true }}
                        required
                        label="Nº máx. de parcelas"
                        type="text"
                        id="numeroMaximoParcelasPlano"
                        name="numeroMaximoParcelasPlano"
                        aria-describedby="my-helper-text"
                        defaultValue={calculatedData.numeroMaximoParcelasPlano}
                      />
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            value={"on"}
                            defaultChecked={
                              calculatedData.distribuirAcrescimosEDescontos === "on" ? true : false
                            }
                      ...
                      <Select
                        ...
                        required
                        disabled={
                          calculatedData.distribuirAcrescimosEDescontos === "on" ? false : true
                        }
                  ...
                  <Grid item>
                    <FormControl className={classes.fields}>
                      ...
                      />
                      <FormHelperText>
                        Esta é apenas a simulação de parcelamento no contrato. Esta simulação, é a
                        distribuição máxima de parcelas para este plano.{" "}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                </Grid>
                      ...
                      <FormControl component="fieldset">
                        ...
                        >
                          <FormControlLabel
                            ...
                            label="Permitir escolha do dia no ato da matrícula"
                          />
                          <FormControlLabel
                            value="true"
                            control={<Radio required />}
                            label="Definir dias específicos para o vencimento"
                          />
                        </RadioGroup>
                      </FormControl>
                    )}
                    ...
                    {calculatedData && calculatedData.vencimento === "true" && (
                      <>
                        ...
                        <FormControl className={classes.formControl}>
                          ...
                          <FormHelperText>
                            {" "}
                            Escolha os dias que deseja permitir o vencimento.{" "}
                          </FormHelperText>
                        </FormControl>
                      </>
                    )}
                    ...
                    {plan && (
                      <FormControl className={classes.fields}>
                        <TextField
                          ...
                          defaultValue={plan && plan.descricaoPlano}
                          type="text"
                          id="descricaoPlano"
                          name="descricaoPlano"
                          aria-describedby="my-helper-text"
